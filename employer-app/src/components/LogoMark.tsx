...
export function LogoMark({ size = 30, showText = true }: Props) {
  return (
    <View style={styles.container}>
      <LinearGradient colors={[...gradients.logo]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}
...
const styles = StyleSheet.create({
  ...
  letter: { color: colors.ink, fontWeight: '900', letterSpacing: -0.04 },
  wordmark: { color: colors.ink, fontWeight: '900', letterSpacing: -0.05 },
});
